...
Although we know that both features are unrelated to the outcome value, feature 2 in the list. Why is this the case? How does this influence interpreting the relative importances of continuous and categorical features in practise, how categorical features with different amounts of levels? Have a think about this before this week's Q&A.
